...
public class PlatformController {
    ...
    public ResponseEntity languages(@RequestParam(required = false) String language, @RequestParam(required = false) Long offset, @RequestParam(required = false) Long itemPerPage){
