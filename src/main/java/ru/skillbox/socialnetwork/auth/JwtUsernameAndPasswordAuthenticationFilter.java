...
public class JwtUsernameAndPasswordAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public JwtUsernameAndPasswordAuthenticationFilter(AuthenticationManager authManager, JwtConfig jwtConfig, PersonDAO personDAO) {
    ...
    private void enrichAuthenticationResponse(HttpServletResponse response, boolean success,
        ...
        try {
            if (success) {
                ...
                // personApi.setTown_id(person.getTown());
                // personApi.setCountry_id();
