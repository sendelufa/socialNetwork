...
public class FriendsService {
   ...
   private FriendsApi mapFriendshipToFriendsApi(@NotNull List<Friendship> list,
       FriendsParameters parameters) {
   ...
   private AbstractResponse sendOk() {
      AbstractResponse response = new ResponseApi("none", System.currentTimeMillis(),
